...
export const metadata = {
  title: "Blog — SocietyApp",
  description: "Tips, guides, and news for society secretaries and RWA presidents managing residential communities in India.",
};
      ...
      <main className="bg-light min-h-screen pt-16">
        ...
        <section className="bg-navy py-20 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto px-5 text-center">
            ...
            <h1 className="font-display text-4xl md:text-5xl font-bold text-white mb-4">Society Management, Simplified</h1>
            <p className="text-white/60 text-lg">Practical guides for secretaries, RWA presidents, and residents across India.</p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              <div className="p-8 flex flex-col justify-between">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-teal text-sm font-semibold group-hover:underline">Read article →</span>
                </div>
              </div>
            </div>
          </Link>
            ...
            {rest.map((post) => (
              <Link key={post.slug} href={`/blog/${post.slug}`} className="group bg-white rounded-2xl border border-gray-100 p-6 hover:border-teal/30 hover:shadow-md transition-all flex flex-col">
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <span className="text-teal text-xs font-semibold">Read →</span>
                </div>
              </Link>
            ))}
          </div>
