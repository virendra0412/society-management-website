//app/features/visitor-management/page.tsx
...
export const metadata = {
  ...
  description: "Gate security without hardware. Pre-approved OTP invites, walk-in logging, trusted visitor passes, and delivery auto-exit — all from one smartphone app.",
};
      ...
      <main className="bg-light min-h-screen pt-16">
        ...
        <section className="bg-white py-16">
          <div className="max-w-3xl mx-auto px-5">
            <h2 className="font-display text-3xl font-bold text-navy text-center mb-10">Visitor Management FAQ</h2>
        ...
        <section className="bg-teal py-16">
          <div className="max-w-3xl mx-auto px-5 text-center">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">Set up visitor management in under 5 minutes</h2>
            <p className="text-white/70 mb-8">Free forever for societies up to 50 units. No credit card. No hardware.</p>
