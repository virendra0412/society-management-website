      ...
      <main className="bg-light min-h-screen pt-16">
        ...
        <article className="max-w-3xl mx-auto px-5 py-14">
          ...
          <div className="mt-10 bg-teal rounded-3xl p-8 text-center">
            <h3 className="font-display text-2xl font-bold text-white mb-2">{tr.blog_cta_title}</h3>
            <p className="text-white/70 mb-6">{tr.blog_cta_sub}</p>
        ...
        {allPosts.length > 0 && (
          <section className="max-w-6xl mx-auto px-5 pb-16">
            <h2 className="font-display text-xl font-bold text-navy mb-5">{tr.blog_more}</h2>
